...
Geocode.setApiKey('AIzaSyApopFoDRPXi3DkUDpwUfsdtiZHZLVPCVY');
Geocode.enableDebug();
    ...
    render() {
        ...
        return (
            <div style={{ padding: '1rem', margin: '0 auto', maxWidth: 1000 }}>
                ...
                <AsyncMap
                    googleMapURL="https://maps.googleapis.com/maps/api/js?key=AIzaSyApopFoDRPXi3DkUDpwUfsdtiZHZLVPCVY&v=3.exp&libraries=geometry,drawing,places"
                    loadingElement={
